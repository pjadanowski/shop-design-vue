      ...
      <div class="container mx-auto px-6">
        <div class="flex">
          <div class="w-1/4 mr-12">
            <h3 class="text-gray-700 text-2xl font-medium">Filter</h3>

            <div class="border border-gray-300 p-6">
              <div class="category border-b border-gray-300">
                <div class="flex justify-between items-center pt-6 pb-10">
                  <h3 class="font-bold text-gray-700">Category</h3>
                  <div class="relative">
                    <select
                      class="block appearance-none w-full bg-white border border-gray-300 text-gray-700 text-sm py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-state"
                    >
                ...
                <div class="price">
                  <h3 class="font-bold text-gray-700 pt-8 pb-10">Price</h3>
